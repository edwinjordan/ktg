...
<section class="content">
      ...
      <div class="card">
        ...
        <form action="<?php echo base_url('Pengiriman/loading_po/'.$po_data->fn_idpo) ?>" method="post" enctype="multipart/form">
        <div class="card-body">
          <div class="card" style="width: 50%; margin: auto; border-radius: 15px">
            <div class="card-body">
              ...
              <div class="button-wrap">
                ...
                <input id="upload" type="file" name="img_loading" required>
              </div>
            </div>
          </div>
        </div>

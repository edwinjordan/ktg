...
<section class="content">
      ...
      <div class="card">
        ...
        <form action="<?php site_url('PO/add_offer_ekspedisi') ?>" method="post" enctype="multipart/form">
        <div class="card-body">
            
              <input type="hidden" name="idpo" class="form-control" value="<?php echo $po_data->fn_idpo ?>" required disabled>
                <table class="table">
                    <div class="row">

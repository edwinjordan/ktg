...
<section class="content">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">Penilaian Barang</h3>
    ...
    <fieldset class="rating">
        <legend>Rating Ekspedisi:</legend>
    ...
    <fieldset class="rating">
        <input type="radio" id="star5-5" name="rating" value="5" /><label for="star5-5" title="Rocks!">5 stars</label>
        <input type="radio" id="star4-5" name="rating" value="4" /><label for="star4-5" title="Pretty good">4 stars</label>
        <input type="radio" id="star3-5" name="rating" value="3" /><label for="star3-5" title="Meh">3 stars</label>
        <input type="radio" id="star2-5" name="rating" value="2" /><label for="star2-5" title="Kinda bad">2 stars</label>
        <input type="radio" id="star1-5" name="rating" value="1" /><label for="star1-5" title="Sucks big time">1 star</label>
    </fieldset>
</div>
<div class="col-md-3">
    <fieldset class="rating">

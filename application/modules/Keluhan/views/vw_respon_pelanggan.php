 ...
 <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Respon ke Pelanggan</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">List Keluhan</a></li>
              <li class="breadcrumb-item active">Respon ke Pelanggan</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
...
<section class="content">
      ...
      <div class="card">
        ...
        <?php echo form_open_multipart('Keluhan/update_respon_kembali_pelanggan/'.$kdkeluhan);?>
        ...
        <div class="card-body">
                    <div class="row">
                        ...
                        <div class="input-group mb-3">
                            <label class="col-sm-2 mt-2">Keterangan</label>
        ...
        <div class="card-footer">
          <button type="submit" class="btn btn-success">Respon Kembali ke Pelanggan</a>
        </div>
      <?php echo form_close(); ?>
        <!-- /.card-footer-->
      </div>
